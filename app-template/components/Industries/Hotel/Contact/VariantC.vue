...
const contactInfo = [
  { label: 'Escape_Mail', value: 'stay@wanderer.hotel' },
  { label: 'Direct_Line', value: '+39 081 000 0000' },
  { label: 'Italy_Hub', value: 'Ravello, Amalfi' },
  { label: 'Spirit_Zone', value: 'The Sanctuary' }
]
</script>
